	...
	<head>
		...
		<style>
			...
			@media only screen and (max-width : 430px) {
				.radio tr td, .radio tr td:last-child{width:100%; display:block;margin-bottom: 5px !important;}
					...
					<?php echo $prompt_message; ?>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										...
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->radio('Type_of_Inquiry', array('General Inquiry','Job Request','Other'),'','','3');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								...
								<div class="group">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->fields('Other_Type_of_Inquiry', 'form_field','Other_Type_of_Inquiry', 'placeholder="Enter other here"');
									?>
									</div>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->mastertextarea('Brief Description of Your Inquiry', '*', 'form_field','Enter brief description of your inquiry here','Brief_Description_of_Inquiry');
									?>
								</div>
							</div>
...
$(document).ready(function() {
	...
	$("#submitform").validate({
		...
		rules: {
			...
			Other_Type_of_Inquiry: "required",
			Brief_Description_of_Inquiry: "required"
		},
		messages: {
			Full_Name: "",
			Phone_Number: "",
			Email_Address: "",
			Type_of_Inquiry: "",
			Other_Type_of_Inquiry: "",
			Brief_Description_of_Inquiry: ""
		}
	});
	...
	/* radio toggle */
	$("input[name='Type_of_Inquiry']").change(function(){
		if($(this).val() == "Other"){
			$("#other").fadeIn();
