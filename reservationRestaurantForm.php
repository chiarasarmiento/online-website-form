                        ...
                        <form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <?php
                                    // @param field name, required, class, replaceholder, rename, id, attrib, value
                                    $input->masterfield('When will you be dining with us?', '*', 'form_field Date1 DisablePast', 'Enter date here', 'Date_of_Dine_In');
                                    ?>
                                    <div class="group">
                                        <?php $input->label('Time', '*'); ?>
                                        <div class="input-group clockpicker" data-align="left" data-donetext="Done">
                                            <input type="text" class="form-control" name="Time_of_Dine_In" placeholder="Enter time here">
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <?php
                                        $input->label('Number of Adults in your party');
                                        // @param field name, required, class, replaceholder, rename, id, attrib, value

                                        ?>
                                        <input type="text" class="form_field" name="Number_of_Adults" maxlength="" onkeypress="return isNumberKey(event)" placeholder='Enter number here'>
                                    </div>
                                    <div class="group">
                                        <?php
                                        $input->label('Number of Children in your party');
                                        // @param field name, required, class, replaceholder, rename, id, attrib, value
                                        ?>
                                        <input type="text" class="form_field" name="Number_of_Children" maxlength="" onkeypress="return isNumberKey(event)" placeholder='Enter number here'>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $("#submitform").validate({
                rules: {
                    ...
                    Name: "required",
                    Date_of_Dine_In: "required",
                    Time_of_Dine_In: "required"
                },
                messages: {
                    Contact_Number: "",
                    Name: "",
