                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        $input->label('Description and Services', '*');
                                        $input->textarea('Description_and_Services', 'form_field', 'Description_and_Services', 'placeholder="Enter description and services here"');
                                        ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        $input->fields('Knew_about_us_through', 'form_field', 'Knew_about_us_through', 'placeholder="Enter answer here"');
                                        ?>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#submitform").validate({
                rules: {
                    ...
                    Description_and_Services: "required"
                },
                messages: {
                    Full_Name: "",
                    Phone_Number: "",
