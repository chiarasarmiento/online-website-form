...
if ($_POST) {
	...
	if (
		empty($_POST['Name_of_Company_or_Individual']) ||
				...
				<div class="form_frame_b">
					<div class="form_content">
						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<p class="strong_head">Who is this delivery for?</p>
							<input type="hidden" name="Deliver To" value=":">
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<div class="group">
										...
										// @param field name, class, id and attribute
										$input->fields('Consignee', 'form_field', 'Consignee', 'placeholder="Enter cosignee here"');
										?>
									</div>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<div class="group">
										<?php
										$input->label('Order Details', '');
										// @param field name, class, id and attribute
										$input->textarea('Order_Details', 'form_field', '', 'placeholder="Enter details here"');
										?>
									</div>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<div class="group">
										<?php
										$input->label('Additional Notes / Instructions', '');
										// @param field name, class, id and attribute
										$input->textarea('Additional_Notes_or_Instructions', 'form_field', '', 'placeholder="Enter details here"');
										?>
									</div>
								</div>
							</div>
