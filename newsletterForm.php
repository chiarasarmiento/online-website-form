...
if ($_POST){
	...
	$prompt_message = '<div id="error-msg"><div class="message"><span>Required Fields are empty</span><br/><p class="error-close">x</p></div></div>';
		...
		$success_message =  '<div id="success"><div class="message"><span>THANK YOU</span><br/> <span>for subscribing!</span><br/><span>We will be in touch with you soon.</span><p class="close">x</p></div></div>';
...
<html class="no-js" lang="en-US">
	<head>
		...
		<link rel="stylesheet" href="style.min.css?ver23asas">
			...
			<?php $input->phone(true); ?><link rel="stylesheet" href="css/intlTelInput.css">
