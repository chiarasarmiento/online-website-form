		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="font-family: Poppins,sans-serif;font-size:14px; padding-bottom: 20px;"> 
					...
					foreach ($_POST as $key => $value) {
						...
						if (!empty($value)) {
							...
							if ($value == ':') {
							 ...
							 $body .= ' <tr margin-bottom="10px"> <td colspan="5" height="28" class="OFDPHeading" width="100%" style=" background:#F0F0F0; margin-bottom:5px;"><b style="padding-left: 4px;">' . $key2 . '</b></td></tr>';
							...
							}else if($key == "Automatically_Refill_Prescriptions_When_Due"){
								...
								<span style="position:relative !important;"><b>' . $key2 . '</b></span >:</td> <td class="Values2"colspan="2" height="28" align="left" width="50%" padding="10" style="line-height: normal; word-wrap: anywhere; "><span style="margin-top: 7px; position:relative;margin-left: 7px; border-collapse: collapse; display: inline-block;margin-bottom: 5px;margin-right: 7px;">'. $_POST['Automatically_Refill_Prescriptions_When_Due'] .'</span></td></tr>';
							


							}else if($key == "Notify_When_Prescriptions_Are_Ready"){
								$body .= '<tr><td class="Values1"colspan="2" height="50px" align="left" width="40%" padding="100" style="line-height: normal; padding-left: 4px;text-justify: inter-word; word-wrap: anywhere; padding-right: 28px;">
								<span style="position:relative !important;"><b>' . $key2 . '</b></span >:</td> <td class="Values2"colspan="2" height="28" align="left" width="50%" padding="10" style="line-height: normal; word-wrap: anywhere; "><span style="margin-top: 7px; position:relative;margin-left: 7px; border-collapse: collapse; display: inline-block;margin-bottom: 5px;margin-right: 7px;">'. $_POST['Notify_When_Prescriptions_Are_Ready'] .'</span></td></tr>';
...
$prescriptions = array ('- Please Select -','No, thanks','Yes, by email', 'Yes, by phone');
?>
<!DOCTYPE html>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											$input->checktxt('Automatically_Refill_Prescriptions_When_Due', 'Yes', 'Yes, I want my prescriptions to be automatically refilled when it is due.');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col2">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->select('Notify_When_Prescriptions_Are_Ready', 'form_field', $prescriptions);
										?>
									</div>
								</div>
							</div>
