...
function locationInfo() {
    ...
    this.getCities = function(id) {
        ...
        call.send(data, url, method, function(data) {
            jQuery('.cities').find("option:eq(0)").html("Select city here");
            if(data.tp == 1){
                if(data.hits > 1000)
                {
    ...
    this.getStates = function(id) {
        ...
        call.send(data, url, method, function(data) {
            jQuery('.states').find("option:eq(0)").html("Select state here");
            if(data.tp == 1){
                if(data.hits > 1000)
                {
                    //alert('Free usage far exceeded. Please subscribe at geodata.solutions.');
    ...
    this.getCountries = function() {
        ...
        call.send(data, url, method, function(data) {
            jQuery('.countries').find("option:eq(0)").html("Select country here");
