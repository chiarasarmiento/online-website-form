						...
						<p class="strong_head">WHO IS THIS PRESCRIPTION FOR?</p>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<div class="group">
										<?php
											$input->label('Delivery Options', '');
											// @param field name, class, id and attribute
											$input->radio('Delivery_Option', array('Pick-up RX','Deliver RX'),'Delivery_Option','','2');
										?>
									</div>
								</div>
							</div>
							
							<div class="form_box" id="deliver">
								<div class="form_box_col1">
									<div class="group">
										<?php
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->select('Notify_when_prescription(s)_are_ready', 'form_field', $choices);
										?>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
	...
	/* radio toggle */
	$("input[name='Delivery_Options']").change(function(){
			if($(this).val() == "Deliver RX"){
				$("#deliver").fadeIn();
				$("#deliver").find(':input').attr('disabled', false);
			}else{
				$("#deliver").fadeOut();
				$("#deliver").find(':input').attr('disabled', 'disabled');
			}
		});
