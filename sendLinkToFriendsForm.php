...
if ($_POST) {
    ...
    if (
        ...
        $success_msg = '<div id="success"><div class="message"><span>THANK YOU</span><br/> <span>for your referral!</span><br/><span>Your confidence in us is greatly appreciated.</span><p class="close">x</p></div></div>';
                        ...
                        <form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    ...
                                    <?php
                                    // @param field name, required, class, replaceholder, rename, id, attrib, value
                                    $input->masterfield('To (Email)', '*', 'form_field', 'example@domain.com', 'To_Email');
                                    ?>
                                </div>
                            </div>
                            <div class="form_box">
                                <div class="form_box_col2">
                                    ...
                                    <?php
                                    // @param field name, required, class, replaceholder, rename, id, attrib, value
                                    $input->masterfield('From (Email)', '*', 'form_field', 'example@domain.com', 'From_Email');
                                    ?>
                                </div>
                            </div>
                            <div class="form_box">
