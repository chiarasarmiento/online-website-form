	...
	<head>
		...
		<style>
			...
			@media only screen and (max-width : 780px) {
				.resp .text_uppercase {margin-top: 20px; }
				.timeresp .text_uppercase  {display: none;}
			}
			...
			.d-label {font-size:14.5px !important; font-weight:bold; padding-top:10px; text-transform: uppercase;}
				...
				<div class = "form_frame_b">
					...
					<?php echo $prompt_message; ?>
							...
							<div class="form_box">
								<div class="form_box_col3">
									...
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->fields('Contact_Number', 'form_field','Contact_Number','placeholder="Enter number here"');
										?>
									</div>
									<div class="group">
										<?php
								...
								<p class="fieldheader">When Do You Need Our Service?</p>
								<input type="hidden" name="When Do You Need Our Service?" value=":">
								...
								<div class="form_box_col2">
									<div class="group">
										<?php
											...
											$input->label('Date', '*');
											// @param field name, class, id and attribute
											$input->fields('Date_of_Service_Needed', 'form_field Date1 DisablePast','Date_of_Service_Needed','placeholder="Enter date here"');
										?>
									</div>
									<div class="group">
										<?php $input->label('Time', '*'); ?>
										<div class="input-group clockpicker" data-align="left" data-donetext="Done">
										<input type="text" class="form-control" name="Time_of_Service_Needed" placeholder="Enter time here">
							...
							<div class="form_box">
								<div class="form_box_col1">
									<div class="group">
										<?php
											// @param label-name, if required
											$input->label('What Service(s) Do You Need?');
											// @param field name, class, id and attribute
											$input->fields('Service(s)_Needed', 'text form_field','Service(s)_Needed','placeholder="Enter service(s) needed here"');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->textarea('Additional_Details', 'text form_field','Additional_Details','placeholder="Enter additional details about your reservation here" style="height: 172px;"');
										?>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
	...
	$("#submitform").validate({
		rules: {
			...
			Date_of_Service_Needed: "required",
			Time_of_Service_Needed: "required"
		},
		messages: {
			Full_Name: "",
			Email_Address: "",
			Contact_Number: "",
			Complete_Address: "",
			Date_of_Service_Needed: "",
			Time_of_Service_Needed: ""
		}
	});
		/* select disable */
